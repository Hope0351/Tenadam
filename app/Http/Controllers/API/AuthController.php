...
class AuthController extends AppBaseController
{
    ...
    public function sendPasswordResetLinkEmail(Request $request): JsonResponse
    {
        ...
        // $data['link'] = 'https://tenedam_flutter.page.link/?link=http://com.example.tenedam_flutter/'.$data['token'].'&apn=com.example.tenedam_flutter';

        $data['link'] = $request->url_domain.'//tenedam.com/createNewPassword?token='.$data['token'].'&email='.$request->email.'&apn=com.example.tenedam_flutter';
