<div class="d-flex align-items-center py-1">
    <a href="<?php echo e(route('appointment-calendars.index')); ?>"
        class="btn btn-icon btn-primary <?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'ms-2' : 'me-2'); ?>">
        <i class="fas fa-calendar-alt fs-3"></i>
    </a>
    <div class="ms-0 ms-md-2" wire:ignore>
        <div
            class="dropdown d-flex align-items-center <?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'ms-2' : 'me-4'); ?> me-md-5">
                ...
                <div class="p-5">
                    <div class="mb-5">
                        ...
                        <select class="form-select status-selector " id="appointmentStatus" data-control="select2"
                            ...
                            <option value="3"><?php echo e(__('messages.live_consultation.cancelled')); ?></option>
                        </select>
                    </div>
...
<?php /**PATH /home/z/my-project/hms/resources/views/appointments/filter-button.blade.php ENDPATH**/ ?>