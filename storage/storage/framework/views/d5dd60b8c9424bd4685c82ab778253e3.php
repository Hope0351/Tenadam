            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    <select class="form-select status-selector " id="bed_filter_status" data-control="select2"
                        ...
                        <option value="1"><?php echo e(__('messages.bed.available')); ?></option>
                        <option value="2"><?php echo e(__('messages.bed.not_available')); ?></option>
                    </select>
                </div>
...
<?php /**PATH /home/z/my-project/hms/resources/views/beds/filter-button.blade.php ENDPATH**/ ?>