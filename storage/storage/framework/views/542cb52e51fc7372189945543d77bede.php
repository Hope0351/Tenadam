...
<div>
    <div class="row">
        <div class="col-12 mb-4">
            <div class="row g-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Invoices'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-invoices">
                        <a class="text-decoration-none" href="<?php echo e(route('invoices.index')); ?>">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e(getCurrencySymbol()); ?> <?php echo e(formatCurrency($invoiceAmount)); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.dashboard.total_invoices')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Bills']): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-bills">
                        <a href="<?php echo e(route('bills.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e(getCurrencySymbol()); ?> <?php echo e(formatCurrency($billAmount)); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.dashboard.total_bills')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Payments'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-payments">
                        <a href="<?php echo e(route('payments.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e(getCurrencySymbol()); ?> <?php echo e(formatCurrency($paymentAmount)); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.dashboard.total_payments')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Advance Payments'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-advance">
                        <a href="<?php echo e(route('advanced-payments.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e(getCurrencySymbol()); ?> <?php echo e(formatCurrency($advancePaymentAmount)); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.dashboard.total_advance_payments')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Beds'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-beds">
                        <a href="<?php echo e(route('beds.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($availableBeds); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.dashboard.available_beds')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Doctors'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-doctors">
                        <a href="<?php echo e(route('doctors.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($doctors); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.dashboard.doctors')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Patients'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-patients">
                        <a href="<?php echo e(route('patients.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($patients); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.dashboard.patients')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Nurses'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-nurses">
                        <a href="<?php echo e(route('nurses.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                ...
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($nurses); ?></h2>
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Admin'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-admins">
                        <a href="<?php echo e(route('admins.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                <div class="widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-shield-halved fs-1-xl text-white"></i>
                                </div>
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($admins); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.admin')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Accountants'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-accountants">
                        <a href="<?php echo e(route('accountants.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                <div class="widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-file-invoice-dollar fs-1-xl text-white"></i>
                                </div>
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($accountants); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.accountants')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Lab Technicians'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-lab">
                        <a href="<?php echo e(route('lab-technicians.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                <div class="widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-vial-virus fs-1-xl text-white"></i>
                                </div>
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($labTechnicians); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.lab_technicians')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Pharmacists'] == true): ?>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget tn-widget-pharmacists">
                        <a href="<?php echo e(route('pharmacists.index')); ?>" class="text-decoration-none">
                            <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                <div class="widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-prescription fs-1-xl text-white"></i>
                                </div>
                                <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                    <h2 class="fs-1-xxl fw-bolder"><?php echo e($pharmacists); ?></h2>
                                    <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.pharmacists')); ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-xxl-3 col-xl-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($modules['Receptionists'] == true): ?>
                <div class="widget tn-widget-receptionists mb-3">
                    <a href="<?php echo e(route('receptionists.index')); ?>" class="text-decoration-none">
                        <div class="position-relative bg-white shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between">
                            ...
                            <div class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-start' : 'text-end'); ?>">
                                <h2 class="fs-1-xxl fw-bolder"><?php echo e($receptionists); ?></h2>
                                <h3 class="mb-0 fs-5 fw-bold text-dark"><?php echo e(__('messages.receptionists')); ?></h3>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="card overflow-auto">
                <div class="card-header pb-0 px-10 my-2">
                    <h3 class="mb-0"><?php echo e(__('messages.dashboard.notice_boards')); ?></h3>
                </div>
                <div class="card-body pt-7 pb-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($noticeBoards) > 0): ?>
                        <table class="table table-striped">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $noticeBoards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noticeBoard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <a href="javascript:void(0)" data-id="<?php echo e($noticeBoard->id); ?>"
                                                class="text-decoration-none notice-board-view-btn"><?php echo e(Str::limit($noticeBoard->title, 24, '...')); ?></a>
                                        </td>
                                    </tr>
                    ...
                    <?php else: ?>
                        <h2 class="mb-0 text-center fs-2"><?php echo e(__('messages.dashboard.no_notice_yet')); ?>... </h2>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-xxl-5 col-12 mb-xxl-0">
            <div class="card overflow-auto">
                <div class="card-header pb-0 px-10">
                    <h3 class="mb-0"><?php echo e(__('messages.enquiries')); ?></h3>
                </div>
                <div class="card-body pt-7">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($enquiries) > 0): ?>
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th scope="col"><?php echo e(__('messages.enquiry.name')); ?></th>
                                    <th scope="col"><?php echo e(__('messages.enquiry.email')); ?></th>
                                    <th scope="col" class="text-center text-muted"><?php echo e(__('messages.common.created_on')); ?></th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-600 fw-bold">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $enquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo e(route('enquiry.show', $enquiry->id)); ?>"
                                                class="text-primary-800 text-decoration-none mb-1 fs-6"><?php echo e(Str::limit($enquiry->full_name, 10, '...')); ?></a>
                                        </td>
                                        <td class="<?php echo e(getCurrentLoginUserLanguageName() == 'ar' ? 'text-end' : 'text-start'); ?>">
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4032561112-0', null);
...
</div><?php /**PATH /home/z/my-project/hms/resources/views/livewire/dashboard.blade.php ENDPATH**/ ?>