            ...
            @if ($component->paginationVisibilityIsEnabled())
                @if ($component->paginationIsEnabled() && $component->perPageVisibilityIsEnabled())
                    <div
                        ...
                        <span
                            class="{{ getCurrentLoginUserLanguageName() === 'ar' ? 'ms-3' : 'me-3' }} text-gray-600 fs-4 fs-xl-6">@lang('messages.common.show')</span>
                    ...
                    @else
                        <div class="row">
                            <div
                                class="col-12 {{ getCurrentLoginUserLanguageName() === 'ar' ? 'me-3' : 'ms-3' }} text-gray-600 fs-4">
