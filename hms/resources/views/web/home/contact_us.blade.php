...
@php
    ...
    $mapUrl = \App\Models\FrontSetting::where('key', 'location_map')->value('value');
@endphp
@section('content')
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="{{ asset('web_front/images/page-banner/Contact.png') }}" alt="Tenedam"
                            class="img-fluid" />
                    </div>
                </div>
            </div>
                ...
                @if(!empty($mapUrl))
                    <div class="contact-card">
                        ...
                        <div class="contact-form-box">
                            @include('web.partial.contact_form_partial')
                        </div>
                    </div>
                @else
