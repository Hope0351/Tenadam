...
'prefix_tooltip' => 'أدخل أي بادئة تحتوي على حروف وأرقام (مثال: ABC، ABC01). سيقوم النظام بزيادة الرقم الأخير تلقائيًا (ABC01 → ABC02). إذا لم يتم العثور على رقم، فسيبدأ الترقيم من 1 أو من رقم البداية الذي قمت بتعيينه.',
    ...
    'map' => [
        ...
        'label' => 'كود تضمين خريطة جوجل',
        'placeholder' => '<iframe src="..."></iframe>',
        'how_to_add' => 'كيفية إضافة خريطة جوجل:',
        'step_1' => 'اذهب إلى',
        'google_map' => 'خرائط جوجل',
        'step_2' => 'ابحث عن موقعك',
        'step_3' => 'اضغط على',
        'share' => 'مشاركة',
        'step_4' => 'اختر',
        'embed' => 'تضمين خريطة',
        'step_5' => 'اضغط على',
        'copy' => 'نسخ HTML',
        'step_6' => 'الصق الكود في الحقل أدناه',
        'save' => 'حفظ',
        'cancel' => 'إلغاء',
    ],
    ...
    'email_template' => [
        ...
        'click_variable' => 'انقر على متغير لإدراجه في محتوى البريد الإلكتروني',
        'available_variable' => 'المتغيرات المتاحة',
        'email_template' => 'قوالب البريد الإلكتروني',
        'email_template_saved_successfully' => 'تم حفظ قالب البريد الإلكتروني بنجاح.',
    ],
    // insurance keys
    'insurance' => [
        'insurance' => 'تأمين',
